              ...
              <div class="row gy-3 overflow-hidden">
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control border-0 border-bottom rounded-0" name="username" id="username" placeholder="ex: hominhnhut" required>
                ...
                <div class="show-error text-danger">
                <span>${error}</span>
                </div>
                <div class="col-12">
